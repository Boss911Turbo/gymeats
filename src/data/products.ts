...
export const WHATSAPP_NUMBER = "+447743978220";
...
export const sheepProducts: Product[] = [
  ...
  {
    id: "mutton-leg",
    name: "Mutton Legs (Pair)",
    category: "bulk-mutton",
    type: "per-pack",
    price: 47.99,
    priceLabel: "per pair",
    badge: "Sold as Pair Only",
    description: "Whole mutton legs, sold as a pair only — bigger and more flavourful than lamb. Perfect for roasting low and slow until the meat falls off the bone, or cut into thick steaks for the grill. A showstopper centrepiece for family gatherings and Eid celebrations.",
    unitLabel: "pair",
    options: [{ label: "Cut Style", choices: ["Whole", "1-inch Steaks", "Diced"], default: "Whole" }],
  },
  {
    id: "mutton-shoulder",
    name: "Mutton Shoulder (Pair)",
    category: "bulk-mutton",
    type: "per-pack",
    price: 36.99,
    priceLabel: "per pair",
    badge: "Sold as Pair Only",
    description: "Rich and tender mutton shoulder, sold as a pair only — ideal for slow roasting until it falls apart, or diced for hearty stews and curries. Beautiful marbling throughout delivers an unmatched depth of flavour. One of the most rewarding cuts to cook.",
    unitLabel: "pair",
  ...
  },
  {
    ...
    type: "per-pack",
    price: 0,
    priceLabel: "limited — enquire",
    badge: "⏳ Limited Item",
    contactOnly: true,
    description: "Cleaned mutton trotters — a traditional delicacy prized for their rich, collagen-packed broth. Slow-cooked into paya, nihari or hearty stews, they deliver an unmatched depth of flavour and serious nutritional value. Strictly limited stock — enquire to reserve.",
    unitLabel: "pack",
    image: "/images/mutton-trotters.jpg",
  },
];
...
export const chickenProducts: Product[] = [
  ...
  },
  {
    ...
    description: "Whole chicken wings — 3kg box. Full three-joint wings (drumette + flat + tip), crispy and crunchy. The ultimate snack or party food. Season, bake, fry or air-fry for game nights, BBQs and gatherings. Toss in your favourite sauce for an unbeatable crowd-pleaser.",
    note: "Chicken is outsourced from a reputable alternative halal-certified supplier.",
    unitLabel: "box",
...
export const extrasProducts: Product[] = [
  ...
  // Beef Bones (Limited)
  {
    ...
    badge: "⏳ Limited Item",
    contactOnly: true,
    description: "Nutrient-rich beef bones — packed with collagen and minerals. Perfect for homemade bone broth that's liquid gold, or split for luxurious roasted bone marrow on toast. A superfood that supports gut health, joints and skin. Strictly limited stock — enquire to reserve.",
    options: [
