      ...
      <section className="bg-primary text-primary-foreground py-16 md:py-24">
        <div className="container-tight">
          ...
          <p className="text-lg text-primary-foreground/70 max-w-xl">
            We supply restaurants, takeaways, butcher shops, caterers, and food businesses. No middlemen — we are the whole process.
          </p>
        </div>
      </section>
      ...
      <section className="container-tight py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            { icon: <Store size={24} />, title: "Flexible Orders", desc: "Weekly bulk drops or one-off large orders — tailored to you." },
          ].map(item => (
      ...
      <section className="bg-muted py-16">
        <div className="container-tight">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
            {["Restaurants", "Takeaways", "Butcher Shops", "Caterers", "Hotels", "Schools", "Meal Prep Companies", "Food Trucks"].map(type => (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Input
                id="businessType"
                required
                placeholder="e.g. Restaurant, Butcher Shop, Caterer"
            ...
            <div>
              ...
              <Textarea
                ...
                required
                rows={5}
                placeholder="Tell us about your typical order size, products you're interested in, delivery frequency, etc."
                value={form.details}
